    ...
    <nav className="fixed top-0 left-0 w-full h-16 bg-black text-white z-50 shadow-lg border-b border-white/10">
      <div className="w-full flex items-center justify-between py-2 px-4">
        ...
        <ul className="hidden md:flex space-x-6">
          <li>
            <Link href="/" className="nav-link hover:text-pink-400 transition-colors">
              Home
            </Link>
          </li>
          <li>
            <Link href="/upcoming" className="nav-link hover:text-pink-400 transition-colors">
              Tournaments
            </Link>
          </li>
          <li>
            <Link href="/Contact_Us" className="nav-link hover:text-pink-400 transition-colors">
              Contact Us
            </Link>
          </li>
        </ul>
